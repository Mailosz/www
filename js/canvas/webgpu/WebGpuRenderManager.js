...
export class WebGpuRenderManager extends RenderManager {
    ...
    updateViewport(state) {
        const sx = 2 / state.viewport.w;
        const sy = -2 / state.viewport.h;
        const tx = -1 - state.viewport.x * sx;
        const ty = 1 - state.viewport.y * sy;
