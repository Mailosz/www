...
const style = /*css*/`
    ...
    #popup-wrapper[open], #popup-wrapper:popover-open {
        opacity: 1;
        @starting-style {
            opacity: 0;
        }
    ...
    #popup-wrapper[open]::backdrop, #popup-wrapper:popover-open::backdrop {
    ...
    #popup-wrapper[open] #popup-container, #popup-wrapper:popover-open #popup-container {
        filter: blur(0);
...
export class OxDialog extends OxControl {
